...
struct ProfileEditView: View {
    ...
    private var aboutTab: some View {
        VStack(alignment: .leading, spacing: AppSpacing.md) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text("Name").font(AppFonts.subheadline).foregroundColor(AppColors.secondaryText)
    ...
    private var accountTab: some View {
        VStack(alignment: .leading, spacing: AppSpacing.md) {
            ...
            VStack(spacing: AppSpacing.md) {
                socialTextField(title: "Instagram", placeholder: "@ahmed_riyadh", text: $instagram, assetIcon: "icon_instagram", fallbackSystemIcon: "camera.aperture")
                socialTextField(title: "X", placeholder: "@ahmed_riyadh", text: $x, assetIcon: "icon_x", fallbackSystemIcon: "xmark")
                socialTextField(title: "WhatsApp", placeholder: "+966 50 123 4567", text: $website, assetIcon: "icon_whatsapp", fallbackSystemIcon: "message")
            }
            Spacer()
        }
        .padding()
    ...
    private func socialTextField(title: String, placeholder: String, text: Binding<String>, assetIcon: String?, fallbackSystemIcon: String) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack(spacing: 10) {
                Group {
                    if let name = assetIcon, UIImage(named: name) != nil {
                        Image(name)
                            .resizable()
